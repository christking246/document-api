...
type Documenter interface {
	Extension() string
	Name() string
	SerializeRequest(endpoint data.EndpointMetaData) string                                                                                                            // this returns the serialized request for a single endpoint (maybe this should not be part of the interface)
