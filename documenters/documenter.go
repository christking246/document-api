...
type Documenter interface {
	Extension() string
	Name() string
	SerializeRequest(endpoint data.EndpointMetaData) string                                                                                    // this returns the serialized request for a single endpoint (maybe  this should be part of the interface)
